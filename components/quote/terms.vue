     ...
     <div class="accordion mt-5" role="tablist">
          <b-card bg-variant="transparent" border-variant="success" no-body class="mb-1 rounded-sm py-2">
               <b-card-header header-tag="header"  class="bg-white cursor-pointer px-3 border-0 d-flex align-items-center justify-content-between" role="tab" v-b-toggle.accordion-1>
                    ...
                    <b-icon class="h3 mb-0 text-dark" :icon="visible ? 'dash' : 'plus'"></b-icon>
               </b-card-header>
               <b-collapse v-model="visible" id="accordion-1"  accordion="my-accordion" role="tabpanel">
                    <b-card-body>
                         <div class=" h5">

                              <p class="font-weight-bold  mb-3">OVERVIEW</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 1 – ONLINE STORE TERMS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 2 – GENERAL CONDITIONS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 3 – ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 5 – PRODUCTS OR SERVICES (if applicable)</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 6 – ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 7 – OPTIONAL TOOLS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 8 – THIRD-PARTY LINKS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 9 – USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 10 – PERSONAL INFORMATION</p>
                              
                              Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy.
                              
                              
                              
                              <p class="font-weight-bold mt-5 mb-3">SECTION 11 – ERRORS, INACCURACIES AND OMISSIONS</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 12 – PROHIBITED USES</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 13 – DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 14 – INDEMNIFICATION</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 15 – SEVERABILITY</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 16 – TERMINATION</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 17 – ENTIRE AGREEMENT</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 18 – GOVERNING LAW</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 19 – CHANGES TO TERMS OF SERVICE</p>
                              ...
                              <p class="font-weight-bold mt-5 mb-3">SECTION 20 – CONTACT INFORMATION</p>
                              
                              Questions about the Terms of Service should be sent to us at marketing@ecolawn.nz.
                              
                              <p class="font-weight-bold mt-5 mb-3">SECTION 21 – SHIPPING AND RETURNS</p>
